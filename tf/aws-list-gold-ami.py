...
DISTROS = dict(
    am2      =  'aws2'      # images don't have a productcode so use special case
...
AMI_ALIAS = dict(  # this should work with describe_images(image_ids=[])
    am2      =  '/aws/service/ami-amazon-linux-latest/amzn2-ami-hvm-x86_64-gp2',
...
def main():
    ...
    # doesn't work with multiple profiles.
